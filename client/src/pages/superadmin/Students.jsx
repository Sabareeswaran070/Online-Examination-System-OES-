        ...
        <div className="space-y-6 p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">View and manage all students across colleges</p>
                </div>
            </div>
            ...
            <Card>
                ...
                <div className="overflow-x-auto">
                    <Table columns={columns} data={users} loading={loading} emptyMessage="No students found" />
                </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="text-sm text-gray-600">
                        ...
                        <span className="font-medium">{totalUsers}</span> students
                    </div>
